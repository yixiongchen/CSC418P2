##############################################################################
#
#  Sample Makefile for C/C++ applications for the CDF environment.
...
CFLAGS        = -Wall -c -O4 -I./include

# Define C++ compiler options
CCCFLAGS      = -Wall -c -O4 -I./include
...
# Define all C++ source files here
CPPSRCS       = PlantLife.cpp  imgui.cpp  imgui_draw.cpp  imgui_impl_glut.cpp
